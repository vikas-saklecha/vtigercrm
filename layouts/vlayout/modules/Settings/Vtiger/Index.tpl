		...
		<div class="row-fluid">
			<span class="span4 row-fluid">
				<a href="index.php?module=Users&parent=Settings&view=List">
					...
					<span class="span3 font-x-large" style="margin-top:17px;margin-left:10px">{vtranslate('LBL_ACTIVE_USERS',$MODULE)}</span>
				</a>
			</span>
			<span class="span4 row-fluid">
				...
				<h2 style="font-size: 44px" class="themeTextColor pull-left">{$ACTIVE_WORKFLOWS}</h2>
					<span class="span3 font-x-large" style="margin-top:17px;margin-left:10px">{vtranslate('LBL_WORKFLOWS_ACTIVE',$MODULE)}</span>
				</a>
			</span>
			<span class="span4 row-fluid">
				...
				<h2 style="font-size: 44px" class="themeTextColor pull-left">{$ACTIVE_MODULES}</h2>
					<span class="span3 font-x-large" style="margin-top:17px;margin-left:10px">{vtranslate('LBL_MODULES',$MODULE)}</span>
				</a>
			</span>
		</div>
		<br><br>
